    ...
    render() {
        ...
        return (
            <>
                ...
                <Drawer className='drawer-width' anchor="right" open={this.state.right} onClose={this.toggleDrawer('right', false)}>
                    <div
                        role="presentation"
                    ...
                    >
                        <Box className='basket-alert-container'>
                            ...
                            <Typography className='typography-margin-20' variant="h5">{`Сумма покупки: ${summa} рублей`}</Typography>
                            {
                            ...
                            <Button onClick={()=>this.toPath('/backet')} color='secondary' variant='outlined'>Перейти в корзину</Button>
                        </Box>
                        <List>
                            <ListItem>
